...
Long-form architecture research for the autonomous supervisor and local testing stack lives in [`Deep Research Reports/`](./Deep%20Research%20Reports/). Safe for public portfolio use: no credentials, only design and ops context for RightsTune.
